...
export default function Stats() {
  return (
    <section id="stats" className="relative py-32 md:py-44 overflow-hidden bg-ink-800/30">
      ...
      <div className="mx-auto max-w-[1500px] px-5 md:px-8 relative">
        <div className="max-w-4xl mb-20">
          ...
          <h2 className="h-display text-5xl md:text-6xl lg:text-7xl leading-[0.95]">
            <span className="block overflow-hidden">
              <SplitText text="המספרים מספרים" stagger={0.04} duration={1} />
            </span>
            <span className="block overflow-hidden text-stroke">
              <SplitText text="את הסיפור." stagger={0.04} duration={1} delay={0.1} />
            </span>
          </h2>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <div className="num-display text-[10px] text-accent/80 mb-3 uppercase tracking-widest">[ 0{index + 1} ]</div>
        <div className="flex items-baseline gap-1 mb-4">
          <motion.span className="num-display text-6xl md:text-7xl font-black tracking-tighter">{display}</motion.span>
